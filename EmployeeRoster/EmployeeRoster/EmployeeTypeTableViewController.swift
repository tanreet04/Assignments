...
protocol EmployeeTypeTableViewControllerDelegate : AnyObject{
    func employeeTypeTableViewController(_ controller: EmployeeTypeTableViewController,didSelect: EmployeeType)
}
...
class EmployeeTypeTableViewController: UITableViewController {
    ...
    override func tableView(
        ...
        if let employeeType{
            delegate?
                .employeeTypeTableViewController(self, didSelect: employeeType)
        }
